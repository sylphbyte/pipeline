...
func (m *mockContext) WithMark(marks ...string)              {}
...
func (m *mockContext) TakeMarks() map[string]interface{}     { return nil }
...
func (m *mockContext) Trace(pkg, action string, data any)            {}
...
func (m *mockContext) Release()                                                           {}
func (m *mockContext) SendError(code string, err error, extras ...map[string]interface{}) {}
func (m *mockContext) SendInfo(code string, extras ...map[string]interface{})             {}
func (m *mockContext) SendSuccess(code string, extras ...map[string]interface{})          {}
func (m *mockContext) SendWarning(code string, extras ...map[string]interface{})          {}
